...
REQUIRED_PRODUCT_TERMS = (
    ...
    "Current sky",
    "Historical resonance timeline",
    "Primary cycles",
    "Confidence index",
    "matched events",
    "context events",
    "why this match",
    "Generated by Astro Global",
    "Human reviewed",
    "Sources included",
)
...
def main() -> None:
    ...
    _assert("const views" in shell_js, "shell.js does not expose static view data.")
