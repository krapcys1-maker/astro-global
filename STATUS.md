...
2. Nastepny krok AI: wykonac pierwszy reczny live run z wybranym dostawca/modelem i sprawdzic, czy walidator przepuszcza tekst bez halucynacji; live output pozostaje draftem do review, nie publikacja.
